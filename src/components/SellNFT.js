...
export default function SellNFT() {
    ...
    const onChangeFile = async (e) => {
        ...
        try {
            ...
            console.log("the Error during file upload", e);
        }
    }
    ...
    const listNFT = async (e) => {
        ...
        try {
            ...
            updateMessage("Please Wait ... upload(upto 5 mins)");
            ...
            alert("Successfully listed you NFT!");
            updateMessage("");
            updateFormParams({ name: '', description: "", price: "" });
            window.location.replace("/");
        } catch (e) {
            console.log("the listNFT error:", e);
        }
    }
